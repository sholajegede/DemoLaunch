  ...
  return (
    ...
    >
      {url.video.includes("res.cloudinary.com") ? (
        <div className="rounded-[1.5rem] overflow-hidden w-[300px] h-[505px] bg-white dark:bg-gray-800">
          <video
        ...
        <div className="rounded-[1.5rem] overflow-hidden w-[300px] bg-white dark:bg-gray-800">
