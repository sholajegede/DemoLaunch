...
export interface CreatorInvoiceProps {
  className?: string;
}

const CreatorInvoice: FC<CreatorInvoiceProps> = ({
  className = "",
  ...
  useEffect(() => {
    newRequest
      .get(`/brand/getBrand/${businessName}`)
      .then((response) => {
        if (response.data) {
  ...
  useEffect(() => {
    if (newDeliverable && newRate && newDeliveryTime) {
  ...
  const handleCreateInvoice = async (e) => {
    ...
    if (!newDeliverable || isNaN(newRate) || !newDeliveryTime) {
  ...
  const handleTimeframeChange = (event) => {
    ...
    setSubmissionTime(calculateSubmissionTime(value));
  };
  ...
  return (
    <>
      <div
        className={`nc-CreatorInvoice ${className}`}
        data-nc-id="CreatorInvoice"
      >
        <Helmet>
          <title>Chat Invoice</title>
        </Helmet>
        <div className="mt-20">
          <main>
            <Tab.Group>
            ...
            <span className="block mt-5 mb-3 text-base text-neutral-500 lg:text-base md:text-base dark:text-neutral-400">
              Create a new booking invoice for:{" "}
              <span className="font-semibold capitalize text-primary-6000">
                {businessName}
              </span>
            </span>
            ...
            <div className="mt-8 space-y-5 sm:space-y-6 md:sm:space-y-8">
              ...
              <label className="block">
                ...
                <div className="mt-1.5 flex">
                  ...
                  <Input
                    ...
                    name="email"
                    className="!rounded-l-none"
                    placeholder="Type in the brand's email address"
                    rows={1.5}
                    value={brand.email}
                  />
                </div>
              ...
              <label className="block mt-6">
                <Label>
                  Booking Rate <span className="text-red-500">*</span>
                </Label>
                <div className="mt-1.5 flex">
                  <span className="inline-flex items-center px-2.5 rounded-l-2xl border border-r-0 border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 text-neutral-500 dark:text-neutral-400 text-sm">
                  ...
                  <Input
                    ...
                    min="5000"
                    className="!rounded-l-none"
                    placeholder="What are you charging for it?"
                    rows={1}
                    value={newRate}
              ...
              <label className="block mt-6">
                ...
                <div className="mt-1.5 flex">
                  ...
                  <Textarea
                    ...
                    name="notes"
                    className="!rounded-l-none"
                    placeholder={`Type other notes you would like ${businessName} to receive`}
                    rows={4}
                    value={newNotes}
