import HowToHeadingCreator from "shared/Heading/HowToHeadingCreator";
...
export interface HowToCreatorProps {
  videos?: VideoType[];
  className?: string;
}
...
const VIDEOS_DEMO: VideoType[] = [
  {
    ...
    thumbnail:
      "https://res.cloudinary.com/newlink/image/upload/v1683582716/getcollabo/Screenshot_90_sbgboh.png",
  },
];

const HowToCreator: FC<HowToCreatorProps> = ({
  videos = VIDEOS_DEMO,
  className = "",
}) => {
  ...
  return (
    <div className={`nc-HowToCreator ${className}`}>
      <HowToHeadingCreator
        desc="Watch how easy it is to use GetCollabo to manage your collaborations with brands."
      >
        🎬 Creator Demo
      </HowToHeadingCreator>
