...
const InfluencerLogin: FC<InfluencerLoginProps> = ({ className = "" }) => {
  ...
  return (
    <div className={`nc-PageLogin ${className}`} data-nc-id="PageLogin">
      <Helmet>
        <title>Logged Out - GetCollabo</title>
      </Helmet>
      <div className="container mb-24 lg:mb-32">
        <h2 className="mt-16 flex items-center text-3xl leading-[115%] md:text-5xl md:leading-[115%] font-semibold text-neutral-900 dark:text-neutral-100 justify-center">
          Login
        </h2>
        <span className="flex items-center justify-center mt-6 mb-12 text-sm text-neutral-500 dark:text-neutral-400">
          You have been logged out! Kindly log back in
        </span>
