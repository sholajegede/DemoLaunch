...
const Welcome: FC<WelcomeProps> = ({ className = "" }) => {
  ...
  return (
    <>
      {influencerProfile.verified === false ? (
        ...
        <div
          className={`nc-Welcome overflow-hidden relative ${className}`}
          data-nc-id="Welcome"
        >
          <Helmet>
            <title>Welcome </title>
                ...
                <div className="flex items-center">
                  <div className="flex items-center ml-3">
                    <div className="flex items-center space-x-1 xl:space-x-3">
                      <Link
                        to={"/dashboard"}
                        className="hidden xl:block sm:block md:block lg:block"
                      >
                        <ButtonPrimary sizeClass="py-2 px-4">
                          ...
                          <span className="ml-2 font-normal">New workflow</span>
                        </ButtonPrimary>
                      </Link>

                      <Link
                        to={"/dashboard"}
                        className="block xl:hidden sm:hidden md:hidden lg:hidden"
                      >
                        <ButtonPrimary sizeClass="py-2 px-4">
                          <svg
                            className="w-5 h-5"
                          ...
                          <span className="ml-2 text-sm font-normal">New</span>
                        </ButtonPrimary>
                      </Link>
