...
import CreateTask from "containers/TaskManager/CreateTask";

export interface TaskManagerProps {
  className?: string;
}

const TaskManager: FC<TaskManagerProps> = ({ className = "" }) => {
  ...
  return (
    <>
      {influencerProfile.verified === false ? (
        ...
        <div
          className={`nc-TaskManager overflow-hidden relative ${className}`}
          data-nc-id="TaskManager"
        >
          <Helmet>
          ...
          <div className="p-4 mb-24 pb-80 sm:ml-64">
            <CreateTask />
          </div>
        </div>
      )}
