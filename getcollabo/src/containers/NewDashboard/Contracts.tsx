...
import BookingContracts from "containers/Contracts/BookingContracts";

export interface ContractsProps {
  className?: string;
}

const Contracts: FC<ContractsProps> = ({ className = "" }) => {
  ...
  return (
    <>
      {influencerProfile.verified === false ? (
        ...
        <div
          className={`nc-Contracts overflow-hidden relative ${className}`}
          data-nc-id="Contracts"
        >
          <Helmet>
                  ...
                  >
                    ...
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        // Add any other path attributes here
