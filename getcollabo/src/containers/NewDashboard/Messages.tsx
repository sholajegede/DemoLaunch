...
import InfluencerConvo from "containers/ChatsPage/InfluencerConvo";

export interface MessagesProps {
  className?: string;
}

const Messages: FC<MessagesProps> = ({ className = "" }) => {
  ...
  return (
    <>
      {influencerProfile.verified === false ? (
        ...
        <div
          className={`nc-Messages overflow-hidden relative ${className}`}
          data-nc-id="Messages"
        >
          <Helmet>
