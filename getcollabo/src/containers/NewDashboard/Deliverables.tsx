...
import InfluencerDeliverables from "containers/Dashboards/InfluencerDeliverables";

export interface DeliverablesProps {
  className?: string;
}

const Deliverables: FC<DeliverablesProps> = ({ className = "" }) => {
  ...
  return (
    <>
      {influencerProfile.verified === false ? (
        ...
        <div
          className={`nc-Deliverables overflow-hidden relative ${className}`}
          data-nc-id="Deliverables"
        >
          <Helmet>
          ...
          <div className="p-4 mb-24 pb-80 xl:pb-72 sm:pb-[220px] sm:ml-64">
