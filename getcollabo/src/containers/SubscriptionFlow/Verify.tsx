...
const Verify: FC<VerifyProps> = ({ className = "" }) => {
  ...
  const handleVerification = async (e) => {
    ...
    try {
      ...
      history.push(`/verified/${priceId}/${amount}`);
    } catch (error) {
      console.log(error);
  ...
  return (
    <div className={`nc-Verify ${className}`} data-nc-id="Verify">
      <Helmet>
        <title>Verify Creator</title>
      </Helmet>
