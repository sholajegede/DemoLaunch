...
export interface CreateInfluencerPageProps {
  className?: string;
  sizeClass?: string;
  fontClass?: string;
  rounded?: string;
...
const CreateInfluencerPage: FC<CreateInfluencerPageProps> = ({
  className = "",
}) => {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      history.push(`/verify/${priceId}/${amount}`);
    } catch (error) {
  ...
  return (
    <div>
      {brand ? (
        ...
        <div
          className={`nc-CreateInfluencerPage ${className}`}
          data-nc-id="CreateInfluencerPage"
        >
          <Helmet>
            ...
            <div className="max-w-4xl mx-auto my-12 space-y-8 sm:lg:my-16 lg:my-24 sm:space-y-10">
              ...
              <div className="max-w-2xl">
                ...
                <span className="block mt-3 text-sm xl:text-lg lg:text-lg md:text-sm text-neutral-500 dark:text-neutral-400">
                  Fill in your display name, username, email address and
                  password to get started on GetCollabo.
                </span>
              </div>
              ...
              >
                <form className="mt-10 space-y-5 md:mt-0 sm:space-y-6 md:sm:space-y-8">
                  ...
                  <FormItem label="Display Name">
                    <Input
                      placeholder="E.g The Layi Wasabi"
                      id="displayName"
                  ...
                  <FormItem
                    ...
                    desc={
                      <div>
                        Write just your username. [E.g: getcollabo.io/book/
                  ...
                  {loading && (
                    <div className="flex items-center mt-2">
                      ...
                      <span className="ml-2 text-sm">Signing you up...</span>
                    </div>
                  )}
