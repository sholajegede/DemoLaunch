...
const MonthlySubscriptions: FC<MonthlySubscriptionsProps> = ({
  className = "",
}) => {
  ...
  const flutterwaveFlow = async (e) => {
    e.preventDefault();
    const url = "https://flutterwave.com/pay/getcollabo-monthly";
    window.location.href = url;
  };
  ...
  return (
    <div
      className={`nc-MonthlySubscriptions container pb-24 lg:pb-32 ${className}`}
      data-nc-id="MonthlySubscriptions"
    >
      <Helmet>
