...
import CreatorInvoice from "containers/CreatorInvoice/CreatorInvoice";

export interface ChatInvoiceProps {
  className?: string;
}

const ChatInvoice: FC<ChatInvoiceProps> = ({ className = "" }) => {
  ...
  return (
    <div
      className={`nc-ChatInvoice overflow-hidden relative ${className}`}
      data-nc-id="ChatInvoice"
    >
      <Helmet>
