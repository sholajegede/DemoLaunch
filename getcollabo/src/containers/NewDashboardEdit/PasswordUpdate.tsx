...
import UpdatePassword from "containers/AccountPageEdits/UpdatePassword";

export interface PasswordUpdateProps {
  className?: string;
}

const PasswordUpdate: FC<PasswordUpdateProps> = ({ className = "" }) => {
  ...
  return (
    <div
      className={`nc-PasswordUpdate overflow-hidden relative ${className}`}
      data-nc-id="PasswordUpdate"
    >
      <Helmet>
