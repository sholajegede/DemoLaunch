...
import ConnectedProfiles from "containers/AccountPageEdits/ConnectedProfiles";
...
const Socials: FC<SocialsProps> = ({ className = "" }) => {
  ...
  return (
    <div
      className={`nc-Socials overflow-hidden relative ${className}`}
      data-nc-id="Socials"
    >
      <Helmet>
        <title>Socials - Rate Card</title>
