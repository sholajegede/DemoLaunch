...
import EditSubscription from "containers/PageSubcription/EditSubscription";

export interface SubscriptionProps {
  className?: string;
}

const Subscription: FC<SubscriptionProps> = ({ className = "" }) => {
  ...
  return (
    <>
      {influencerProfile.verified === false ? (
        ...
        <div
          className={`nc-Subscription overflow-hidden relative ${className}`}
          data-nc-id="Subscription"
        >
          <Helmet>
