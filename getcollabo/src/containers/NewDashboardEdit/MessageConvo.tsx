...
export interface MessageConvoProps {
  className?: string;
}

const MessageConvo: FC<MessageConvoProps> = ({ className = "" }) => {
  ...
  return (
    <>
      {influencerProfile.verified === false ? (
        ...
        <div
          className={`nc-MessageConvo overflow-hidden relative ${className}`}
          data-nc-id="MessageConvo"
        >
          <Helmet>
          ...
          <div className="sticky pt-2 pl-4 pr-4 pb-[52px] sm:pb-2 lg:pb-2 xl:pb-2 sm:ml-64">
            <InfluencerChat />
          </div>
        </div>
      )}
