...
import UpdateVideoSample from "containers/AccountPageEdits/UpdateVideoSample";

export interface VideosProps {
  className?: string;
}

const Videos: FC<VideosProps> = ({ className = "" }) => {
  ...
  return (
    <div
      className={`nc-Videos overflow-hidden relative ${className}`}
      data-nc-id="Videos"
    >
      <Helmet>
        <title>Videos - Rate Card</title>
      ...
      <div className="pt-4 pl-4 pr-4 xl:pl-12 xl:pr-12 sm:ml-64">
        <UpdateVideoSample />
      </div>
    </div>
  );
