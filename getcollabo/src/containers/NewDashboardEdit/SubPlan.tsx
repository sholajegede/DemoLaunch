...
import ChangePlan from "containers/PageSubcription/ChangePlan";

export interface SubPlanProps {
  className?: string;
}

const SubPlan: FC<SubPlanProps> = ({ className = "" }) => {
  ...
  return (
    <>
      {influencerProfile.verified === false ? (
        ...
        <div
          className={`nc-SubPlan overflow-hidden relative ${className}`}
          data-nc-id="SubPlan"
        >
          <Helmet>
