...
import PreviewInvoice from "containers/CreatorInvoice/PreviewInvoice";

export interface PreviewingInvoiceProps {
  className?: string;
}

const PreviewingInvoice: FC<PreviewingInvoiceProps> = ({ className = "" }) => {
  ...
  return (
    <div
      className={`nc-PreviewingInvoice overflow-hidden relative ${className}`}
      data-nc-id="PreviewingInvoice"
    >
      <Helmet>
      ...
      <div className="p-4 pl-3.5 pr-3.5 mb-2 xl:pl-12 xl:pr-12 sm:ml-64">
        <PreviewInvoice />
      </div>
    </div>
  );
...
export default PreviewingInvoice;