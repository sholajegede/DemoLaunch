...
import PreviewDeliverable from "containers/CreatorInvoice/PreviewDeliverable";

export interface ViewDeliverableProps {
  className?: string;
}

const ViewDeliverable: FC<ViewDeliverableProps> = ({ className = "" }) => {
  ...
  return (
    <div
      className={`nc-ViewDeliverable overflow-hidden relative ${className}`}
      data-nc-id="ViewDeliverable"
    >
      <Helmet>
      ...
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul className="mt-3 space-y-2 text-sm">
            ...
            <li>
              <NavLink
                to={`/view/${username}/${deliverableId}`}
