...
import Invoice from "containers/CreatorInvoice/Invoice";

export interface CreateInvoiceProps {
  className?: string;
}

const CreateInvoice: FC<CreateInvoiceProps> = ({ className = "" }) => {
  ...
  return (
    <div
      className={`nc-CreateInvoice overflow-hidden relative ${className}`}
      data-nc-id="CreateInvoice"
    >
      <Helmet>
