...
export interface DeliverContentProps {
  className?: string;
}

const DeliverContent: FC<DeliverContentProps> = ({ className = "" }) => {
  ...
  return (
    <div
      className={`nc-DeliverContent overflow-hidden relative ${className}`}
      data-nc-id="DeliverContent"
    >
      <Helmet>
        <title>Deliver Content</title>
      ...
      <div className="pt-4 pl-4 pr-4 xl:pr-20 sm:ml-64">
        <SubmitDeliverable />
      </div>
    </div>
  );
