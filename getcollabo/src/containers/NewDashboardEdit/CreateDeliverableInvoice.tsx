...
import DeliverableInvoice from "containers/CreatorInvoice/DeliverableInvoice";

export interface CreateDeliverableInvoiceProps {
  className?: string;
}

const CreateDeliverableInvoice: FC<CreateDeliverableInvoiceProps> = ({ className = "" }) => {
  ...
  return (
    <div
      className={`nc-CreateDeliverableInvoice overflow-hidden relative ${className}`}
      data-nc-id="CreateDeliverableInvoice"
    >
      <Helmet>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Rate Card</span>
                {/**
      ...
      <div className="p-4 pl-3.5 pr-3.5 mb-24 xl:pl-12 xl:pr-12 sm:ml-64">
        <DeliverableInvoice />
      </div>
    </div>
  );
...
export default CreateDeliverableInvoice;