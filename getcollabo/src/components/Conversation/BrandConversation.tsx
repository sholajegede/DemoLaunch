...
const BrandConversation: FC<BrandConversationProps> = ({
  ...
  return (
    ...
    >
      <div className="mt-1 bg-white dark:bg-gray-800 rounded-2xl">
        <div className="px-4 py-3 border-2 rounded-2xl dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700">
