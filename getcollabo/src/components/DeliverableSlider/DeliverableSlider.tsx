...
export interface DeliverableSliderProps {
  className?: string;
...
const DeliverableSlider: FC<DeliverableSliderProps> = ({
  heading = "",
  subHeading = "",
  className = "",
  itemClassName = "",
  ...
  return (
    <div className={`nc-DeliverableSlider ${className}`}>
...
export default DeliverableSlider;
