                    ...
                    {newNotifications.length ? (
                      <div className="space-y-4">
                        {newNotifications
                          ...
                          .reverse()
                          .map((item, index) => (
                            <div className="max-w-xs overflow-hidden rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                              <div
                                key={index}
                                className="relative flex p-2 pr-8 -m-3 transition duration-150 ease-in-out rounded-lg focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
                                onClick={() =>
