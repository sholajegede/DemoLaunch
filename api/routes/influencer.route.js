...
import {
  ...
  getInfluencer,
  updateInfluencer,
  updateInfluencerDeliverables,
  updateInfluencerVideoSample,
...
router.put("/deliverables/:id", updateInfluencerDeliverables);

router.put("/videoSample/:id", updateInfluencerVideoSample);

router.put("/bank/:id", updateBankInfo);

router.delete("/delete/:id/deliverables/:deliverableId", deleteDeliverable);

router.put("/edit/:id/deliverables/:deliverableId", updateDeliverableById);

router.put("/editSample/:id/sample/:videoSampleId", updateVideoSampleById);

router.delete("/sampleDelete/:id/videoSamples/:videoSampleId", deleteVideoSample);
...
//Video Samples
router.get("/videoSample/:username/:videoSampleId", getVideoSampleById);
